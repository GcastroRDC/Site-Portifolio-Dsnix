document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('formularioCaptacaoProposta').addEventListener('submit', function(event) {
        ...
        fetch('formularioCaptacaoProposta.php', {
            method: 'POST',
            body: formData
        })
        .then(response => {
        ...
        .then(data => {
            ...
            if (data.success) {
                ...
                document.getElementById('formularioCaptacaoProposta').reset(); // Limpa o formulário
